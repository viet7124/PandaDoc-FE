    ...
    >
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-8">
          <Link to="/login" className="inline-flex items-center justify-center group">
          ...
          <p className="mt-2 text-sm text-white drop-shadow-md">
            ...
            <Link to="/login" className="font-medium text-green-300 hover:text-green-200 underline transition-colors">
              Sign in
            </Link>
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 mt-0.5 text-green-600 border-2 border-gray-300 rounded focus:ring-green-500/25 focus:ring-2 transition-colors"
              />
